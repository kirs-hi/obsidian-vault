...
| `claude "query"` | 带初始[[提示词]]启动 | `claude "explain this project"` |
...
| `claude agents` | 打开 [[07-Agent|Agent]] 视图管理并行会话 | `claude agents --json` |
| `claude attach <id>` | 接入后台会话 | `claude attach 7c5dcf5d` |
| `claude logs <id>` | 查看后台会话日志 | `claude logs 7c5dcf5d` |
| `claude mcp` | 配置 [[理论学习_MCP_协议与开放工具生态|MCP]] 服务器 | `claude mcp add server-name` |
...
- 数据库查询（[[Day5-Supabase和实战项目|Supabase]]、PostgreSQL）
- 知识库搜索
- 项目管理工具集成
- 文件系统扩展操作
