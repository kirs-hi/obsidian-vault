...
![image\.png](../../attachments/THqAbPz0eo2sYGxz97Mc1TShnTh.png)
...
![image\.png](../../attachments/A9JZbrXp8oZM6axPFl0c4DEQnQd.png)
...
![image\.png](../../attachments/BvUEbt5ErohC4uxz3g0croyInMg.png)
...
![image\.png](../../attachments/OapzbalUwoH5JDxwxk3cK2tWnRf.png)
...
![image\.png](../../attachments/CHAXbpL0uor1asxGmuqcjGHWnIb.png)

输入命令敲回车即可：

安装完成之后先别着急拉模型，可以添加两个环境变量：

![image\.png](../../attachments/EqAGbeEoFocBZExQ2V7ci6pMnhb.png)
...
![image\.png](../../attachments/MHzfbAcfookFTyxIiCKct8X3ngc.png)

然后在控制台输入 ollama run deepseek\-r1:7b 运行，我家的网速很一般，这里拉取模型花了不少时间。

截图这会有 2\.5M/s，但不是很稳定，慢的时候只有 300 多 kb，所以这一步需要花时间耐心等一下。

![image\.png](../../attachments/AwuLbo84yoPqExx1RfvcpLsunTc.png)

我差不多是花了一个晚上才搞定，截图都到第二天了，非常消耗耐心。

![image\.png](../../attachments/RhPFbjVmIo0Qs0x8htQcoIEPnbG.png)

等 deepseek 拉取完成后，就可以在控制台进行交互了，直接输入文本进行提问就可以了。

![image\.png](../../attachments/JbX1bXLnuobiR0xONkXcNAFlnEd.png)
...
![image\.png](../../attachments/M6imbCtxeoT8ZlxVzHBcpsr0nuh.png)

application\.yml 中我做了说明。注意本地和 DeepSeek 官方的 URL 不太一样，model 也不一样，key 本地的话不用填写，我本地用的是 7b 版本。

![image\.png](../../attachments/WgATb3neroYh8lxdhBzcPNssnZe.png)

如果成功配置，可以在聊天助手这里进行测试。后台也不会报错。

![image\.png](../../attachments/HbN5bwWadoc18fxTKLkcYQNonyu.png)
