...
![[VGYSbmY2dokRcLxCKRwc8FAQnEh.png]]
...
![[AP0fbZZKNoHTOdxS0DNcTtQongh.png]]
...
![[R8zJbgdNvobGZTxfxUtcqSkHnBe.png]]
...
![[V4hgbWhjNoMHkpxJNYdccppjnDO.png]]

新手可以在 settings 中找到 go 找到 goroot，然后会自动下载 go 的 SDK。

![[ExYSbebbxogyADxzYnec5jglnEg.png]]

如果你是新手，发现代码一只飙红，点开 Go 模块，勾选 Go 模块集成一下就好了。

![[Fea0bYbBYoKPVsxrWw1cJ7b8nmd.png]]
...
![[Ww0nbvKbSohtg7x4LOAcuv3enGc.png]]

一开始没问题，但等安装的时候冲突了，可能前面没有卸载干净。

![[GzYxb2CTVoA8dzxYEBlcyK1qnzc.png]]

![[ETEzb6pzuoVWlTxaBcYc0FZBnnd.png]]

![[ALpObbxVJo9I99xb0iRcxKr5nIg.png]]

执行 open \-a Docker 后确实可以打开 Docker 了。

![[FIAQbLjFCoebtmx4FAPcjTQvn8g.png]]
...
![[Ji65b5Es1oQJrxxDoNxc38VSnNe.png]]
...
![[FAFtbnIndoh6Yaxn951c7s3CnDf.png]]

### Docker 安装前置环境

进入到项目目录下执行命令，我 go 版派聪明是放在这个路径下的，你要进入到你自己的路径下。

![[EiNvbuKZzo1hyoxW9HrcbpxwnIf.png]]
