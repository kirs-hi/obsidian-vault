...
![image\.png](../attachments/MkB0bPnbxoX4vjxHWsdc3ETYnzf.png)

你想让 AI 查今天深圳的天气，它自己查不到，但你可以给它提供一个 get\_weather 的函数说明书。AI 看到你的需求和说明书后，不会直接回答天气，而是输出一段 JSON 代码：“我决定调用 get\_weather ，参数是 深圳 ”。 然后你的代码拿着这个参数去真正调用 API，查到结果后再喂给 AI，AI 最后总结成人类语言回复你。
...
![image\.png](../attachments/E4F5bNn8ToYb6PxeeNfc5pRDn4e.png)
...
![image\.png](../attachments/VpWibyY3PoWnHdxXfvMcxKvfn8Q.png)
...
1. **技能主体（Body）： **这里写的是具体的指令、工作流（Workflow）、规则限制和模板。这里的大白话指令，就是在教大模型“拿到工具后，第一步干啥，第二步干啥”。
...
![image\.png](../attachments/Kj4ZbMR9zoLPnOxDVaycmX3PnVe.png)
