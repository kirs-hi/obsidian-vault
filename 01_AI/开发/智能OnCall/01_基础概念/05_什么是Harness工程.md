...
> 这篇属于项目之外的读物，不学也不影响学习后续的 oncall agent项目的学习。

> 目的是帮助大家理解「Prompt 工程、Context 工程、Harness 工程」
...
![image\.png](../attachments/SLfibv0pTo6w7txhffGc60HTnhf.png)
...
![image\.png](../attachments/KtUUbxqLioflSNxhdeec1JHpnhb.png)
...
![image\.png](../attachments/YteTbR4HtoK8RFxwPVqcgWzyncb.png)
...
![image\.png](../attachments/GkqJbeB1BoknWCxGgYtcomxln0f.png)
...
![image\.png](../attachments/TYGib2Relo6YdWxw76kcm8Finyc.png)
...
![image\.png](../attachments/INu4bVrCiotuWWxLLhec8lbAn0d.png)
...
![image\.png](../attachments/GcBjbr3p3o08zjxktm7cRE6DnOf.png)
...
![image\.png](../attachments/W0btbF9VZoZTmsxkOQBcYTQ1nef.png)
...
![image\.png](../attachments/P84wbe27WoFfTqxiwWmcVMgCnkh.png)
...
![image\.png](../attachments/UW3Cbtq7Fo5QKvxKtkOcyvEXn1d.png)
...
![image\.png](../attachments/HIf3bDrTBohLfdxzz9UcFk5Znxa.png)
...
![image\.png](../attachments/AMqdbxlEvouSY8xcjowczadfn0b.png)
...
![image\.png](../attachments/W47rbNCGRogoHtxmfbCcL9NHnjh.png)
...
![image\.png](../attachments/XA3gbCVFkoOeB1xHfltcNmxOn4e.png)
...
![image\.png](../attachments/JUiubeew0olNQIxREkucPsYHn6b.png)
...
![image\.png](../attachments/DdXFbXNMYoGOSpxF96DcG7Uinl1.png)
...
![image\.png](../attachments/HANubvlX5oGK4oxvsercitQLnod.png)
...
![image\.png](../attachments/M1lsbQ8OuokxS8xDO3Pc1PspnJg.png)
...
![image\.png](../attachments/LxojbmyHiohLrexQNDhcTzNsn5e.png)
...
![image\.png](../attachments/QQhNbbrtpoesbBxVeKvcaBnOnUd.png)
...
![image\.png](../attachments/W9gibuiXWoZWz1xDE4Jct27Pnhf.png)
...
![image\.png](../attachments/YyTnb45nCohwgFxYFsechtDEnFc.png)
...
![image\.png](../attachments/JlszbazyYoOxHLxayeXcQMTMnkc.png)
...
![image\.png](../attachments/WSzybxdV0oTeaAxJA9EcyMOqnKc.png)
...
![image\.png](../attachments/JgldbOJG1oqgw1xgsPkc2uRTnnc.png)
...
![image\.png](../attachments/SWGybxJWcok7qqxZ3t0clg0uncg.png)
...
![image\.png](../attachments/MmpebWpp6o3Du9x98AfcZ4C8nAh.png)
...
![image\.png](../attachments/D2DjbIFi9oPtXtxYZ6Hc6umsnwg.png)
...
![image\.png](../attachments/QXlkb2RGrodV4kxAqYecJ7IXnFg.png)
...
![image\.png](../attachments/LgRqb7t25ob9GnxOb1vcSg5Fn2f.png)
...
![image\.png](../attachments/FjnWb79A3oSg6xxMQZycpzd4nGb.png)
...
![image\.png](../attachments/NLBfbzLYUoTna0xieXHcIdtVnBe.png)
...
![image\.png](../attachments/UJR0buUlDomQioxROSGcXpr4nLg.png)
...
![image\.png](../attachments/JEmgb21BfoIvdGxrYj4ciSKXnbe.png)
...
![image\.png](../attachments/OYqrbEuFFooMLgx27XacibaGn2d.png)
...
![image\.png](../attachments/WnTfboOJLoRS85xrjeEcXbzXnku.png)
...
![image\.png](../attachments/Wz74bLS4Po1pv4xmlXAcRCewnKc.png)
...
![image\.png](../attachments/TiyTbii3Qo8caHxtKwNcApOrnlY.png)

那人类工程师到底在干啥？从他们这套实践里，你能看到工程师的工作重心其实都压在了三件事上面：

1. **把产品目标拆解成 Agent 能力边界内的小任务 **，确保每一件事都是 Agent 接得住的

1. **当 Agent 反复失败时，不是去催它「再努力一点」，而是去看它「环境里缺了什么能力」，然后把那个能力补进环境里**

1. **建立反馈链路，让 Agent 真正能看到自己工作的结果 **，而不是两眼一抹黑地瞎跑
...
![image\.png](../attachments/EFdNblI33oLHDlx5PtQcXLISnfg.png)
...
![image\.png](../attachments/QnSvbETiUogrf9xbMhPc7NY3nKc.png)
...
![image\.png](../attachments/OR6zb4HXLohKU8xjGOCc9PO2nJc.png)
...
![image\.png](../attachments/EKx8bQPaUoNcX4xqsm6c1rrQnbd.png)
...
![image\.png](../attachments/X3Gbbd4eSolpOBxe1ebcjZKenNe.png)
...
![image\.png](../attachments/OTbkbRdxbo137mxFpqHcBIALnlh.png)
...
![image\.png](../attachments/FR1ubWvAwoCvW4xKYZHcRFjenob.png)
...
![image\.png](../attachments/PVBwbWfrwoWDf1xkguMcLVcXnof.png)
...
1. Mitchell Hashimoto，《My AI Adoption Journey》, [https://mitchellh\.com/writing/my\-ai\-adoption\-journey](https://my.feishu.cn/https%3A%2F%2Fmitchellh.com%2Fwriting%2Fmy-ai-adoption-journey)

1. OpenAI，《Harness engineering: leveraging Codex in an agent\-first world, [https://openai\.com/index/harness\-engineering/](https://my.feishu.cn/https%3A%2F%2Fopenai.com%2Findex%2Fharness-engineering%2F)

1. Anthropic，《Effective harnesses for long\-running agents》, [https://www\.anthropic\.com/engineering/effective\-harnesses\-for\-long\-running\-agents](https://my.feishu.cn/https%3A%2F%2Fwww.anthropic.com%2Fengineering%2Feffective-harnesses-for-long-running-agents)

1. Anthropic，《Harness design for long\-running application development》, [https://www\.anthropic\.com/engineering/harness\-design\-long\-running\-apps](https://my.feishu.cn/https%3A%2F%2Fwww.anthropic.com%2Fengineering%2Fharness-design-long-running-apps)

1. Anthropic，《Effective context engineering for AI agents》, [https://www\.anthropic\.com/engineering/effective\-context\-engineering\-for\-ai\-agents](https://my.feishu.cn/https%3A%2F%2Fwww.anthropic.com%2Fengineering%2Feffective-context-engineering-for-ai-agents)

1. LangChain，《Improving Deep Agents with harness engineering》, [https://blog\.langchain\.com/improving\-deep\-agents\-with\-harness\-engineering/](https://my.feishu.cn/https%3A%2F%2Fblog.langchain.com%2Fimproving-deep-agents-with-harness-engineering%2F)

1. Cognition，《Rebuilding Devin for Claude Sonnet 4\.5: Lessons and Challenges》, [https://cognition\.ai/blog/devin\-sonnet\-4\-5\-lessons\-and\-challenges](https://my.feishu.cn/https%3A%2F%2Fcognition.ai%2Fblog%2Fdevin-sonnet-4-5-lessons-and-challenges)
