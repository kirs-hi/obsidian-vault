...
1、是用AI编程工具生成，比如你用cursor、claude code 等，用这些工具生成的优势就是简单，可以不用切换工具，但是呢，你需要有一定设计的基础，你自己能写设计相关的提示词，对于新手来说是有点难度的，而且页面制作的效果也不是太好
...
⬅️ 上一篇：[[【中等项目 1 实战-02】 拆解PRD 文档]] | ➡️ 下一篇：[[【中等项目 1 实战-04】从 Stitch 生成小程序界面]]
