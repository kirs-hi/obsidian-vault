---
title: "安装了这个之后，Claude Code 的体验会完全不一样。"
source: "https://articles.zsxq.com/id_rccbdnr7cvsi.html"
author:
  - "[[AI随风]]"
published:
created: 2026-05-23
...
## Claude Code Setup 安装

安装方式：

/plugin install claude-code-setup@claude-plugins-official

如果我在claude code里面已经安装了这个claude-plugins-official插件，那么可以直接使用这种方式来安装

![](https://article-images.zsxq.com/FhUvHhUSBzWhYRWzRctbOuQf3nF0)

## 使用

![](https://article-images.zsxq.com/Fq10lscMqa-r5UH_wGn5S-gk9JVd)

执行这个命令之后，它会去找整个代码库，去找你的配置文件，所有的这个跟代码有关的东西，然后总结出技能、钩子、子代理等等，非常非常有用。

![](https://article-images.zsxq.com/FgK4rDxG2uV1kYeFUPSNF9MbeswJ)

这里面说的其实都是真实项目中的实际情况，非常合理。所以如果你觉得没问题，就让他去生成或者说安装。

![](https://article-images.zsxq.com/FlEGZMr4UVRXbu9w1BwtwF8LBblj)
