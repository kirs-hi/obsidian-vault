...
![[YKcUb6mfeotWF4xprkLc1yUUneb.png]]
...
![[VUmCbaJnwoxlUDxIzeFc4LqsnUh.png]]
...
![[SR6TbRCs2oRrTXx0dBecVKIdnTe.png]]
...
![[N014bPgj4odgccxAjuNce5Dwnif.png]]
...
![[PKhrbdDaKopwxHxZFUFcuSvAnbg.png]]
...
![[LKWGbdo3loLcb3xIJ9jcgblenjf.png]]
...
![[J931b0IlkoYwnUx2jaMc3F30nDg.png]]
...
![[IAWmb6sgyoHnqlxovsfctLhHn2g.png]]

**②、 用户名和密码 **：默认用户是 elastic，密码会在启动时生成。

![[J0yhbVA5IoDQQkxeIjmcddcrn4b.png]]
...
![[OE4RbjtlIoFRvfxOuiFcdLqInre.png]]

注意⚠️，要记得把 ES 的密码配置到你本地代码的 application\.yml 文件，和前面 ES 生成的密码是匹配的。

![[ZbAHbpSt0okxGOxJ9nUcpzMpnng.png]]
...
![[BGYbbk51NoHaMWxz1WXcW4Icn7c.png]]
...
![[NX98bjTX0ojUYsxNBPCcVeWin5b.png]]
...
![[HMkUbcKhzotzdoxoIoNcGiqVnih.png]]
...
![[WrzabUZWOoCNrkxt9RDcoiMsn4u.png]]

否则会在启动后端的时候报错 初始化索引失败。

![[VVMXb5cFFo85t7xkotLcv7KRnke.png]]
...
![[YlFJbG6FXoH7rJx3oBvcR5zwn3g.png]]
...
![[AKrKb6v5Po9LOUx3XGgc93RtnEb.png]]
...
![[Ox26bBwtuoWFqMxzjrwcmavdnzb.png]]
...
![[VVQNbbNgjoVmsKx5FjacPmaMndc.png]]

这次安装成功了，安装的过程中会提示 y/n，输入 y 就好了。

![[WaYsbXBPiokzx3xTckncdazjnmd.png]]
...
![[Z4esbc9LXoclxlxwNWGcBrwynMf.png]]

或者执行 \./bin/elasticsearch\-plugin lis

![[DwSLbyy5GoLGdixC78JceZmQnUe.png]]
