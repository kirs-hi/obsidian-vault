...
![](理论学习_什么是_Coding_Agent_-2.jpeg)

这就是 Coding [[07-Agent|Agent]] 做的事情。而这门课，就是教你从零把这样一个东西造出来。
...
![](理论学习_什么是_Coding_Agent_-11.jpeg)
...
![](理论学习_什么是_Coding_Agent_-12.jpeg)
...
![](理论学习_什么是_Coding_Agent_-13.jpeg)
...
这门课你会从零构建一个叫 **MewCode** 的 Coding Agent。简单说，它就是一个终端里的 AI 编程助手。你在终端里跟它对话，它能帮你读文件、写代码、执行命令、搜索代码库，而且是自主决策的。

![](理论学习_什么是_Coding_Agent_-14.jpeg)

你可能会问：这不就是 [[Claude Code 命令与最佳实践|Claude Code]] 吗？

确实，MewCode 的设计一定程度上参考了 Claude Code 的架构思想。Claude Code 是目前最成熟的 Coding Agent 之一，它的很多设计决策经过了大量实战打磨，非常值得学习。

MewCode 参考 Claude Code 的架构设计，实现了一个轻量化的 Coding Agent。这门课带你深入理解 MewCode 每个核心模块是怎么设计和实现的：从对话管理到工具系统，从 [[理论学习_ReAct_范式与_Agent_Loop|Agent Loop]] 到权限控制，从[[理论学习_上下文压缩与_Token_管理|上下文管理]]到[[理论学习_跨会话记忆与会话持久化|记忆系统]]，最终拼成一个完整可用的产品。

![](理论学习_什么是_Coding_Agent_-15.jpeg)
...
![](理论学习_什么是_Coding_Agent_-16.jpeg)
...
![](理论学习_什么是_Coding_Agent_-17.jpeg)
