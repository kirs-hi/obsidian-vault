---
title: "《AI大模型Ragent项目》——SpringBoot-SSE服务端实战"
source: "https://articles.zsxq.com/id_w690gl7a8943.html"
author:
  - "[[马丁]]"
published:
created: 2026-06-05
...
后端负责鉴权、限流、日志、对话历史存储，然后代理调用大模型 API，把[[01基础_20SSE协议与流式响应|流式响应]]转发给前端。

### 2\. 完整链路概览

完整的流式转发链路用时序图展示：

![无法获取该图片](https://oss.open8gu.com/iShot_2026-03-06_10.13.29.png "无法获取该图片")
...
| `X-Accel-Buffering no` | 额外的缓冲关闭指令 | 某些场景下 proxy\_buffering off 不生效 |
